...
export default async function DashboardEditEmployeePage({
    params,
    searchParams,
}: {
    ...
    // Permissions: SysAdmin OR HR
    // If we want Managers to edit their subordinates, we'd need more logic here.
    // For now, mirroring Admin permissions.
    if (userType !== 'SYSTEM_ADMIN' && role !== 'HR') {
        // If unauthorized, go back to list
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-2 mb-4">
                <Link href={returnUrl || `/dashboard/employees/${empCode}`}>
            ...
            <Card className="p-6">
                <EmployeeForm
                    ...
                    returnUrl={returnUrl || '/dashboard/employees'}
                />
            </Card>
        </div>
    );
